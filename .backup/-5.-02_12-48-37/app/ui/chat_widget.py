...
class ChatWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.attach_file_button.setIcon(QIcon(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "assets", "icons", "attach.svg")))
        ...
        self.attach_image_button.setIcon(QIcon(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "assets", "icons", "image.svg")))
        ...
        self.emoji_button.setIcon(QIcon(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "assets", "icons", "emoji.svg")))
