...
class DockTitleBar(QWidget):
    ...
    def __init__(self, title="", icon_manager: IconManager = None, parent=None): # Добавлен icon_manager
        """
        ...
        self.title = title
        self.icon_manager = icon_manager if icon_manager else IconManager.instance() # Для обратной совместимости, если не передан
        self._setup_ui()
        self._setup_styles()
    ...
    def _update_icons(self):
        ...
        try:
            ...
            self.float_button.setIcon(self.icon_manager.get_icon(f"float_{icon_suffix}"))
            ...
            self.icon_label.setPixmap(self.icon_manager.get_icon(icon_name).pixmap(16, 16))
...
def apply_custom_title_bar(dock_widget, icon_manager: IconManager, is_docked_permanent=False): # Добавлен icon_manager
    """
    ...
    """
    title_bar = DockTitleBar(dock_widget.windowTitle(), icon_manager, dock_widget) # Передаем icon_manager
