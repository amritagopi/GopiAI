...
from ....app.ui.i18n.translator import tr # Предполагаемый относительный импорт
...
class RenameDialog(QDialog):
    ...
    def __init__(self, name: str = None, parent=None) -> None:
        ...
        self.setWindowTitle(tr("Rename Theme", "Rename Theme"))
        self.setWindowIcon(get_icon("QStylerIcon.png"))
        self.setModal(True)
        self.line = QLineEdit(self)
        self.button_layout = QHBoxLayout()
        self.save_btn = QPushButton(tr("Save", "Save"), self)
        self.cancel_btn = QPushButton(tr("Cancel", "Cancel"), self)
...
class NewDialog(RenameDialog):
    ...
    def __init__(self, name=None, parent=None):
        ...
        self.label.setText(tr("Set Theme Name", "Set Theme Name"))
        self.setWindowIcon(get_icon("QStylerIcon.png"))
        self.setWindowTitle(tr("New Theme", "New Theme"))
        self.setModal(True)
...
class AboutQStyler(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.label = QLabel()
        self.setWindowIcon(get_icon("QStylerIcon.png"))
        self.setWindowTitle(tr("About QStyler", "About QStyler"))
        ...
        self.okay_btn = QPushButton(tr("Okay", "Okay"), self)
