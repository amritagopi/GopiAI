...
class MenuManager(QObject):
    ...
    theme_changed = Signal(str)  # Deprecated - используйте ThemeManager.visualThemeChanged
    language_changed = Signal(str)  # Deprecated - используйте JsonTranslationManager.languageChanged
    ...
    def __init__(self, main_window: QMainWindow, icon_manager): # Добавлен icon_manager
        ...
        Args:
            ...
            icon_manager: Экземпляр IconManager
        """
        super().__init__()
    ...
    def create_actions(self):
        ...
        self.toggle_terminal_action = QAction(
            self.icon_manager.get_icon("terminal"), tr("dock.terminal.toggle", "Terminal"), self.main_window
        )
        ...
        self.toggle_project_explorer_action = QAction(
            self.icon_manager.get_icon("folder"), tr("dock.project_explorer.toggle", "Project Explorer"), self.main_window
        )
        ...
        self.toggle_chat_action = QAction(
            self.icon_manager.get_icon("chat"), tr("dock.chat.toggle", "AI Chat"), self.main_window
        )
        ...
        self.toggle_browser_action = QAction(
            self.icon_manager.get_icon("browser"), tr("dock.browser.toggle", "Browser"), self.main_window
        )
        ...
        self.toggle_coding_agent_action = QAction(
            self.icon_manager.get_icon("code"), tr("dock.coding_agent.toggle", "Coding Agent"), self.main_window
        )
        self.toggle_coding_agent_action.setCheckable(True)
        self.toggle_coding_agent_action.setStatusTip(tr("dock.coding_agent.toggle.tooltip", "Show/hide coding agent window"))

        # Сброс расположения
        self.reset_layout_action = QAction(
            self.icon_manager.get_icon("refresh"), tr("menu.reset_layout", "Reset Layout"), self.main_window
        )
        ...
        self.open_url_action = QAction(
            self.icon_manager.get_icon("link"), tr("menu.tools.open_url", "Open URL"), self.main_window
        )
        ...
        self.run_ui_diagnostics_action = QAction(
            self.icon_manager.get_icon("debug"), tr("menu.tools.run_diagnostics", "Run UI Diagnostics"), self.main_window
        )
        ...
        self.configure_agent_action = QAction(
            self.icon_manager.get_icon("settings"), tr("menu.configure_agent", "Configure Agent"), self.main_window
        )
        ...
        self.view_flow_action = QAction(
            self.icon_manager.get_icon("flow"), tr("menu.view_flow", "View Flow"), self.main_window
        )
        ...
        self.preferences_action = QAction(
            self.icon_manager.get_icon("preferences"), tr("menu.preferences", "Preferences"), self.main_window
        )
        ...
        self.about_action = QAction(
            self.icon_manager.get_icon("info"), tr("menu.about", "About"), self.main_window
        )
        self.about_action.setStatusTip(tr("menu.about.tooltip", "About this application"))

        # Документация
        self.documentation_action = QAction(
            self.icon_manager.get_icon("documentation"), tr("menu.documentation", "Documentation"), self.main_window
        )
        ...
        for theme_name in available_themes:
            ...
            if theme_name in ['light', 'dark']:  # Встроенные темы
                ...
                action.triggered.connect(
                    lambda checked, t=theme_name: theme_manager.switch_visual_theme(t, force_apply=True)
                )
                ...
                # Действие "Применить"
                apply_action = QAction(tr("menu.theme.apply", "Apply"), self.main_window, checkable=True)
                ...
                self.theme_action_group.addAction(apply_action) # Добавляем в общую группу
                custom_theme_submenu.addAction(apply_action)

                # Действие "Удалить"
                delete_action = QAction(tr("menu.theme.delete", "Delete"), self.main_window)
    ...
    def _handle_delete_theme(self, theme_name: str):
        ...
        reply = QMessageBox.question(
            ...
            tr("menu.theme.delete.confirm.text", "Are you sure you want to delete the theme '{theme_name}'?").format(theme_name=theme_display_name),
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            if success:
                ...
                QMessageBox.information(
                    ...
                    tr("menu.theme.delete.success.text", "Theme '{theme_name}' has been deleted.").format(theme_name=theme_display_name)
                )
            else:
                QMessageBox.warning(
                    self.main_window,
                    tr("menu.theme.delete.error.title", "Error Deleting Theme"),
                    tr("menu.theme.delete.error.text", "Could not delete theme '{theme_name}'.").format(theme_name=theme_display_name)
                )
    ...
    def update_language_menu(self):
        ...
        try:
            ...
            language_settings_action = QAction(tr("menu.language.settings", "Настройки языка..."), self.main_window)
            language_settings_action.triggered.connect(self.main_window._show_language_selector)
    ...
    def connect_signals(self):
        ...
        if missing_methods:
            logger.error(f"В главном окне отсутствуют методы: {', '.join(missing_methods)}")
        else:
        ...
        self.toggle_coding_agent_action.triggered.connect(self.main_window._toggle_coding_agent)
