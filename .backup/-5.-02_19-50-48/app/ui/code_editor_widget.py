...
class MultiEditorWidget(QWidget):
    ...
    def __init__(self, parent=None, theme_manager=None):
        ...
        self.new_file_action = QAction(get_icon("new"), tr("editor.new_file", "New File"), self)
        self.new_file_action.triggered.connect(self.new_file)
        self.toolbar.addAction(self.new_file_action)

        self.open_file_action = QAction(get_icon("open"), tr("editor.open_file", "Open File"), self)
        self.open_file_action.triggered.connect(self.open_file)
        self.toolbar.addAction(self.open_file_action)

        self.save_file_action = QAction(get_icon("save"), tr("editor.save_file", "Save File"), self)
        self.save_file_action.triggered.connect(self.save_file)
        self.toolbar.addAction(self.save_file_action)

        self.save_as_action = QAction(get_icon("save-as"), tr("editor.save_as", "Save As"), self)
        ...
        # Кнопки запуска
        self.run_action = QAction(get_icon("run"), tr("editor.run", "Run"), self)
        ...
        self.send_to_chat_action = QAction(get_icon("chat"), tr("editor.send_to_chat", "Send to Chat"), self)
        self.send_to_chat_action.triggered.connect(self.send_selected_to_chat)
        self.toolbar.addAction(self.send_to_chat_action)

        self.check_code_action = QAction(get_icon("check"), tr("editor.check_code", "Check Code"), self)
