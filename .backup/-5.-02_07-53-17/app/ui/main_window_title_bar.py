...
class MainWindowTitleBar(QWidget):
    ...
    def __init__(self, title="", icon_manager=None, parent=None):
        ...
        self.title = title
        self.icon_manager = icon_manager if icon_manager else IconAdapter.instance()
        ...
        try:
            ...
            if self.is_maximized:
                ...
                self.maximize_button.setToolTip(
                    tr("window_title_bar.restore", "Восстановить")
                )
            else:
                self.maximize_button.setIcon(
                ...
                self.maximize_button.setToolTip(
                    tr("window_title_bar.maximize", "Развернуть")
                )
