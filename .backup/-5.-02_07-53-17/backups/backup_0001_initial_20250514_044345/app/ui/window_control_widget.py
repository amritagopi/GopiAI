...
class WindowControlWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.maximize_restore_button.setToolTip(
            tr("window_control.maximize", "Развернуть")
        )
    ...
    def _update_icons(self):
        ...
        try:
            ...
            current_theme = (
                theme_manager.get_current_visual_theme() if theme_manager else "light"
            )
            ...
            logging.error(
                f"Ошибка при обновлении иконок в WindowControlWidget: {str(e)}"
            )
