...
# from app.tool.tavily_tool import TavilyTool  # Удаляем импорт TavilyTool
from app.tool.web_search import WebSearch  # Добавляем импорт WebSearch
...
class Manus(BrowserAgent):
    ...
    available_tools: ToolCollection = Field(
        default_factory=lambda: ToolCollection(
            PythonExecute(), WebSearch(), BrowserUseTool(), StrReplaceEditor(), Terminate()
        )
    )
