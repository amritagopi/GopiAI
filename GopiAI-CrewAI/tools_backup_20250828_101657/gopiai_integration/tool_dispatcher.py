...
class ToolDispatcher:
    ...
    def __init__(self, smart_delegator=None):
        ...
        self.call_limits = {
            'max_calls_per_request': 200,  # Увеличено для сложных задач
            'max_same_tool_calls': 200,    # Увеличено до 200 для предотвращения преждевременной блокировки
...
Я не могу выполнить этот запрос из-за указанной ошибки."""
