...
def create_docks(main_window: QMainWindow):
    ...
    try:
        ...
        apply_custom_title_bar(main_window.chat_dock, main_window.icon_manager, is_docked_permanent=True) # Передаем icon_manager
        ...
        main_window.terminal_dock.visibilityChanged.connect(lambda visible: on_dock_visibility_changed(main_window, visible))
